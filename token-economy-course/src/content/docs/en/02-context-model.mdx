...
Understanding the context model makes [The Hidden Tax](/vibe-on-budget/en/01-hidden-tax) numbers concrete. Apply this knowledge with [Quick Wins](/vibe-on-budget/en/04-quick-wins) and [Writing Prompts That Cost Less](/vibe-on-budget/en/05-cheaper-prompts).
:::
