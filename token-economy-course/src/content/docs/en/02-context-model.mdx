...
Understanding the context model leads to three practical rules:
...
Understanding the context model makes [The Hidden Tax](/token-economy-course/en/01-hidden-tax) numbers concrete. Apply this knowledge with [Quick Wins](/token-economy-course/en/03-quick-wins) and [Writing Prompts That Cost Less](/token-economy-course/en/04-cheaper-prompts).
:::
