...
Team Alpha turned on debug logging and found their most expensive pattern: a 22-turn agent session that cost 1,100 credits fixing a bug that should have taken 3 turns. Measurement revealed what intuition missed: 12,500 → 11,800 credits.
:::
...
1. Pick one task you do regularly (e.g., "add a validation function"). Record: the prompt you used, the model, credits consumed (hover), and whether the result needed a retry. This is your baseline.
