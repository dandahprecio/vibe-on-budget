...
The **Copilot status bar** in VS Code gives you a monthly perspective. Select it to open the status dashboard, where you can see how much of your monthly allowance you have used.[^m3-4] The dashboard includes AI credits and, for Copilot Free, inline suggestions.
