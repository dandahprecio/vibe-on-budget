...
See [Module 7 — Agents, Tools & MCP Hygiene](/token-economy-course/en/07-agents-mcp) for practical MCP management.
:::
...
Internal optimizations make the most sense after understanding the [context model](/token-economy-course/en/02-context-model) and [cost structure](/token-economy-course/en/01-hidden-tax). For practical ways to complement these savings, see [Agents, Tools & MCP Hygiene](/token-economy-course/en/07-agents-mcp).
:::
