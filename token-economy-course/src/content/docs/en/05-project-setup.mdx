...
Research suggests instruction files do not stay small for long. Chakrabarti et al. (arXiv:2608.11095, August 2026) found that instructions grew by **+226%** over their lifetime as teams kept adding one more exception, caveat, or "temporary" rule.
...
A solid project setup makes [Quick Wins](/token-economy-course/en/03-quick-wins) permanent. Then level up with [Agents, Tools & MCP Hygiene](/token-economy-course/en/06-agents-mcp) to manage agent-mode costs.
:::
