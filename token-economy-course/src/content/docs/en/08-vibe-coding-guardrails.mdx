...
Go to [Module 6 — Project Setup](/token-economy-course/en/06-project-setup) and configure AGENTS.md (behavioral contract) + `.prompt.md` files (architecture specs) before writing code. The upfront cost of guardrails is a fraction of the cost of fixing production incidents.
:::
...
`AGENTS.md` defines *how* the agent should behave — mode, scope, output format. Keep it lean (see [Module 6](/token-economy-course/en/06-project-setup)). But *what* the agent should know about your project — architecture, conventions, historical mistakes — belongs in separate `.prompt.md` files loaded on demand.
...
Guardrails work best with the right setup — revisit [Project Setup](/token-economy-course/en/06-project-setup) and [Agents, Tools & MCP Hygiene](/token-economy-course/en/07-agents-mcp). For the full picture on how Copilot manages costs, see [Under the Hood](/token-economy-course/en/09-under-the-hood).
:::
