...
See [Module 3 — Quick Win #6](/token-economy-course/en/03-quick-wins#6-force-unified-diff-output) for how unified diffs eliminate LLM-laziness and reduce output tokens by 70–80%.
...
Pair prompt techniques with [Project Setup](/token-economy-course/en/05-project-setup) for full-stack token efficiency. For advanced patterns, see [Agents, Tools & MCP Hygiene](/token-economy-course/en/06-agents-mcp).

For output format optimization, see [Module 3 — Quick Win #6: Force Unified Diff Output](/token-economy-course/en/03-quick-wins).
:::
