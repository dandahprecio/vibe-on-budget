...
A solid project setup makes [Quick Wins](/token-economy-course/en/04-quick-wins) permanent. Then level up with [Agents, Tools & MCP Hygiene](/token-economy-course/en/07-agents-mcp) to manage agent-mode costs.
:::
