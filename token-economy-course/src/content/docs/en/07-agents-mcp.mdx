...
See [Module 9 — Tool Search](/vibe-on-budget/en/09-under-the-hood) for how it works internally.
:::
...
Agent hygiene builds on [Project Setup](/vibe-on-budget/en/06-project-setup). For a broader view of managing AI-generated code quality, see [Vibe Coding Without the Debt](/vibe-on-budget/en/08-vibe-coding-guardrails).
:::
