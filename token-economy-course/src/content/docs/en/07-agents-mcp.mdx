...
Because roughly **60–70% of requests** are simple enough for a cheaper model, leaving the selector on Auto can reduce model-related costs by about **60–70%** on eligible work while preserving higher-capability models for tasks that need them.
