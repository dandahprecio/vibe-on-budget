...
Now that you understand the cost model, learn [how Copilot builds context](/token-economy-course/en/02-context-model) — it explains why every request costs what it does. Then jump to [Quick Wins](/token-economy-course/en/03-quick-wins) for immediate savings.
:::
