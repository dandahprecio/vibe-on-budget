...
See [Module 4 — Quick Win #6](/vibe-on-budget/en/04-quick-wins#6-force-unified-diff-output) for how unified diffs eliminate LLM-laziness and reduce output tokens by 70–80%.
...
For output format optimization, see [Module 4 — Quick Win #6: Force Unified Diff Output](/vibe-on-budget/en/04-quick-wins).
:::
