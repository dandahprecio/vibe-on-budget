...
| **Tool definitions** | Scheman och beskrivningar för MCP-servrar och andra verktyg | Beror på aktiverade verktyg |
...
Se [Glossary](/vibe-on-budget/en/glossary) för definitioner av bland annat context window, prompt prefix, tokenizer och MCP.
...
Nu vet du *vad* som skickas. Nästa fråga: *vad kostar det?* Gå vidare till [Module 2: Den dolda kostnaden](/vibe-on-budget/en/02-price-and-measurement) för att förstå hur tokenmängd, input, output och cache hänger ihop med användning.

[^m1-1]: [Glossary: Token och BPE](/vibe-on-budget/en/glossary) — kursens definitioner.
