...
Team Alphas standups hade varit på svenska. Genom att byta promptspråk till engelska och använda punktformat sparade teamet ~1 700 tokens per dag. Tillsammans med avsiktskommentarer: 8 900 → 8 200 credits.
:::
...
Svenska tokeniseras **~1,4–1,7× mindre effektivt** än engelska, beroende på tokenizer. Äldre tokenizers (GPT-4, Mistral) visar en större skillnad (~1,7×); nyare tokenizers (GPT-5 o200k) minskar den till ~1,4–1,5×. Detta beror på att engelska har kortare genomsnittlig ordlängd och vanligare delordsmönster.
...
Den praktiska effekten: **skriv promptar på engelska även om du chattar på svenska**. Svaret kommer korrekt tillbaka, och du sparar ~30–40% tokenkostnad, beroende på tokenizer.
