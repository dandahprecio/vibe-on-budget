...
Använd ett tokenräkningsskript för att granska dina filer:[^m6-10]
...
För en mer precis räkning, använd Copilot SDK eller `gh copilot` för att mäta faktisk tokenanvändning per förfrågan. Sätt ett månatligt budgetmål och gå igenom det med ditt team.[^m6-5]
:::
...
:::tip[Fortsätt lära]
En stabil projektuppsättning gör [Agenter, verktyg och MCP-hygien](/vibe-on-budget/sv/07-agents-mcp) mer effektiv. Gå tillbaka till [Snabba vinster](/vibe-on-budget/sv/04-quick-wins) för de snabbaste besparingarna.
:::
...
3. Kör tokenräkningsskriptet (PowerShell eller Node.js) från den här modulen mot dina instruktionsfiler. Hur stor är din alltid-på-baslinje?
