...
> Siffran 200 rader är praktisk vägledning från Vaughans analys, inte ett resultat från originalartikeln, som rapporterar ett medianvärde på 39 instruktioner och 90:e percentilen på 131.
...
VS Code har två inställningar för mer finjusterad exkludering:
