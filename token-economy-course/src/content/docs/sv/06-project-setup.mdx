...
Team Alpha granskade sin copilot-instructions.md — 847 rader hade samlats under 18 månader. De bantade den till 18 rader med den minimala mallen, flyttade arkitekturdokumentation till .prompt.md-filer och lade till .copilotignore. Skatten för alltid-på-kontext försvann: 8 200 → 7 500 credits.
:::
...
Din `.gitignore` påverkar också agenten: matchande filer exkluderas från arbetsytans index och från agentens textsökning/grep. Se den som ett första lager av exkludering.
...
| Inställning | Effekt |
|---|---|
| `files.exclude` | Döljer filer helt från Explorer, arbetsytans index och agentsökning |
| `search.exclude` | Döljer filer från agentens textsökning/grep men behåller dem synliga i Explorer |
