...
:::tip[Fortsätt lära]
En stabil projektuppsättning gör [Snabba vinster](/token-economy-course/sv/04-quick-wins) permanenta. Ta sedan nästa steg med [Agenter, verktyg och MCP-hygien](/token-economy-course/sv/07-agents-mcp) för att hantera kostnader i agentläge.
:::
