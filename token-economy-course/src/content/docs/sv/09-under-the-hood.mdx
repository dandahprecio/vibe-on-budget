...
För vanliga misstag som bryter cachen och hur du undviker dem, se [Modul 2 — Vanliga cache-busting-misstag](/vibe-on-budget/sv/02-context-model#common-cache-busting-misstag).
:::
...
Se [Modul 7 — Agenter, verktyg och MCP-hygien](/vibe-on-budget/sv/07-agents-mcp) för praktisk MCP-hantering.
:::
