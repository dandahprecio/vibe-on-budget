...
Team Alpha aktiverade felsökningsloggning och hittade sitt dyraste mönster: en agentsession på 22 steg som kostade 1 100 credits för att rätta en bugg som borde ha tagit 3 steg. Mätningen visade vad intuitionen missade: 12 500 → 11 800 credits.
:::

## Credit hover per förfrågan

Det snabbaste sättet att granska en förfrågan är att hovra över Copilot-svaret i Chat. VS Code visar **credit consumption** för just det steget. Det är kostnaden för en förfrågan, inte den totala kostnaden för konversationen.
...
Kostnaden per förfrågan är användbar, men visar inte hela notan för en lång agentsession. **Context window control** i chattens inmatningsfält ger dig helhetsbilden. Hovra över eller klicka på den för att se totala credits och tokenuppdelning för den aktuella sessionen.
...
**Copilot-statusfältet** i VS Code ger dig ett månadsperspektiv. Välj det för att öppna statusdashboarden, där du ser hur stor del av din månatliga allowance du har använt. Dashboarden visar AI credits och, för Copilot Free, även inline suggestions.
...
Läs mer om att fråga sessionshistoriken med Chronicle i [VS Code-dokumentationen](https://code.visualstudio.com/docs/agents/run/sessions/session-history#_query-session-history-with-chronicle).
...
För mer detaljerad evidens aktiverar du filloggning i VS Code-inställningarna:
...
I Agent Debug Logs finns också **Cache Explorer**. Den visar prompt cache hit rates och hur många input tokens som återanvändes. Det är viktigt eftersom två sessioner med ungefär lika många tokens kan ha olika kostnad när den ena återanvänder mer cachad input.
