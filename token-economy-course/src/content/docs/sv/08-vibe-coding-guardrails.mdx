...
Gå till [Modul 6 — Projektsetup](/token-economy-course/sv/06-project-setup) och konfigurera AGENTS.md (beteendekontrakt) + `.prompt.md`-filer (arkitekturspecifikationer) innan du skriver kod. Den initiala kostnaden för skyddsräcken är en bråkdel av kostnaden för att åtgärda produktionsincidenter.
:::
...
`AGENTS.md` definierar *hur* agenten ska bete sig — läge, omfattning och outputformat. Håll den smal (se [Modul 6](/token-economy-course/sv/06-project-setup)). Men *vad* agenten ska veta om ditt projekt — arkitektur, konventioner och historiska misstag — hör hemma i separata `.prompt.md`-filer som laddas vid behov.
...
Skyddsräcken fungerar bäst med rätt setup — gå tillbaka till [Projektsetup](/token-economy-course/sv/06-project-setup) och [Agenter, verktyg och MCP-hygien](/token-economy-course/sv/07-agents-mcp). För hela bilden av hur Copilot hanterar kostnader, se [Under huven](/token-economy-course/sv/09-under-the-hood).
:::
