...
Skyddsräcken fungerar bäst med rätt setup — gå tillbaka till [Projektsetup](/vibe-on-budget/sv/06-project-setup) och [Agenter, verktyg och MCP-hygien](/vibe-on-budget/sv/07-agents-mcp). För hela bilden av hur Copilot hanterar kostnader, se [Under huven](/vibe-on-budget/sv/09-under-the-hood).
:::
