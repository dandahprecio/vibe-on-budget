...
Rått tokenantal är missvisande. En session på 10 000 tokens med 60 % cacheträffar är dramatiskt billigare än en session på 5 000 tokens utan cacheträffar. GitHub introducerade formeln **Effective Tokens (ET)** (se [Ordlista](/vibe-on-budget/sv/glossary)) för att normalisera detta i sin text om tokeneffektivitet från maj 2026:[^m1-5]
