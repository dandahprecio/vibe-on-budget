...
Före mitten av 2025 laddades alla scheman vid varje steg. Med verktygssökning (modul 9) laddas bara nödvändiga verktyg. Det är fortfarande viktigt att rensa bort oanvända MCP-servrar — det gör registret mindre och minskar risken att modellen väljer dyra verktyg för enkla uppgifter.

Se [Modul 9 — Verktygssökning](/token-economy-course/sv/09-under-the-hood) för hur det fungerar internt.
:::
...
:::tip[Fortsätt lära]
Agenthygien bygger vidare på [Projektinställningar](/token-economy-course/sv/06-project-setup). För ett bredare perspektiv på att hantera kvaliteten i AI-genererad kod, se [Vibe coding utan skuld](/token-economy-course/sv/08-vibe-coding-guardrails).
:::
