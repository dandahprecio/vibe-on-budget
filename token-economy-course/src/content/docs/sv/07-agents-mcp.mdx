...
Se [Modul 9 — Verktygssökning](/vibe-on-budget/sv/09-under-the-hood) för hur det fungerar internt.
:::
...
:::tip[Fortsätt lära]
Agenthygien bygger vidare på [Projektinställningar](/vibe-on-budget/sv/06-project-setup). För ett bredare perspektiv på att hantera kvaliteten i AI-genererad kod, se [Vibe coding utan skuld](/vibe-on-budget/sv/08-vibe-coding-guardrails).
:::
