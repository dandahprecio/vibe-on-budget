...
I Modul 6 konfigurerade du AGENTS.md och lärde dig hålla instruktionsfiler smala. När du nu använder agentläge avgör de filerna hur mycket tokens varje agentsteg förbrukar. Agentläge och MCP-servrar är Copilots mest kraftfulla funktioner — och de kan öka förbrukningen eftersom agenter kan använda verktyg och iterera genom en uppgift.[^m7-1]
...
Thinking effort styr hur mycket resonemang modellen använder. Högre effort = fler thinking tokens = högre creditförbrukning. Behåll standardvärdet för rutinuppgifter. Öka endast för arkitekturplanering och komplex felsökning.
:::
...
Upprepade submit-, poll- och retrieve-anrop lägger till mellanresultat i kontextfönstret. För deterministiska flöden: kör loopen utanför agentkonversationen och returnera bara slutresultatet.
...
Se [Modul 2 — Cachebrytande misstag](/vibe-on-budget/sv/02-context-model#vanliga-misstag-som-bryter-cachen) för fler mönster som bryter cachen.
...
Använd din representativa uppgift och baslinje från Modul 3. Efter varje övning, jämför credit-förbrukning mot baslinjen.
