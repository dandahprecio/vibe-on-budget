...
I Copilot CLI kan du köra `/context` mitt i sessionen för att se dina System/Tools-tokens. I VS Code kan du uppskatta genom att räkna aktiva MCP-servrar × verktyg × ~200 tokens.[^m7-2]
:::
...
Tala om för agenten när den ska sluta. Utan tydliga gränser itererar agenter tills kontextfönstret eller verktygsbudgeten tar slut.[^m7-2]
