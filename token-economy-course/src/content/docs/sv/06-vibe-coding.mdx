...
*(Se [Glossary](/vibe-on-budget/sv/glossary) för definitioner av vibe coding, agentiskt arbetsflöde, teknisk skuld och skyddsräcken.)*
...
Gå till [Module 5 — Agents, Tools & MCP](/vibe-on-budget/sv/05-agents-mcp) och konfigurera AGENTS.md (beteendekontrakt) + `.prompt.md`-filer (arkitekturspecifikationer) innan du skriver kod. Den initiala kostnaden för skyddsräcken är bara en bråkdel av kostnaden för att rätta produktionsincidenter.
:::
...
`AGENTS.md` definierar *hur* agenten ska bete sig — läge, scope och outputformat. Håll den slimmad (se [Module 5](/vibe-on-budget/sv/05-agents-mcp)). Men *vad* agenten ska veta om ditt projekt — arkitektur, konventioner och historiska misstag — hör hemma i separata `.prompt.md`-filer som laddas vid behov.
...
Skyddsräcken fungerar bäst tillsammans med [Agents, Tools & MCP](/vibe-on-budget/sv/05-agents-mcp) och [Module 7 — Under the Hood](/vibe-on-budget/sv/07-under-the-hood).
:::
