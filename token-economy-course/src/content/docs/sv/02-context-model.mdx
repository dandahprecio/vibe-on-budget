...
```
Öppna sedan Chatt-vyn → **...** → **[Show Agent Debug Logs](https://code.visualstudio.com/docs/agents/agent-troubleshooting)** → fliken **Summary** för att se tokenantal per förfrågan.
:::
...
Använd förgrening när du vill utforska en alternativ lösning eller ställa en sidofråga utan att betala prefixkostnaden igen. Till skillnad från `/clear` och [/compact](https://code.visualstudio.com/docs/agents/run/sessions/manage-sessions#_compact-conversation-context) är förgrening till för divergerande utforskning — parallella spår — inte för att fortsätta samma uppgift i en mindre kontext.

Se [Fork a chat session](https://code.visualstudio.com/docs/agents/run/sessions/manage-sessions#_fork-a-chat-session) i VS Code-dokumentationen. Kommandot [/compact](https://code.visualstudio.com/docs/agents/run/sessions/manage-sessions#_compact-conversation-context) hanterar konversationskontexten.[^m2-15]
...
OpenAI dokumenterar kontroller för cacheretention, inklusive förlängd retention på upp till 24 timmar i distributioner som stöder det; tillgänglighet och standardvärden beror på modell, organisation och policy för datalagring. Cacheåteranvändning är inte garanterad, så följ träffdata i stället för att budgetera som om varje förfrågan träffar.[^m2-1][^m2-12]
