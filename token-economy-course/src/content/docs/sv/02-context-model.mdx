...
OpenAI GPT-5.x stöder utökad cachning med `prompt_cache_retention: "24h"`. VS Code Copilot uppmätte en **919 % förbättring av träfffrekvensen efter pauser på 40–60 minuter** och **338 % efter pauser på 30–40 minuter**. Det är särskilt värdefullt för asynkrona arbetsflöden där stegen ligger flera minuter från varandra.

### Förlängd TTL förändrar ekonomin för asynkront arbete

OpenAI:s 24-timmarsfönster för lagring kan hålla det dyra prefixet aktivt under normala utvecklingspauser i stället för att cachen försvinner mellan asynkrona steg. För arbetsflöden med längre mellanrum mellan förfrågningar innebär det färre kalla starter och lägre effektiv tokenkostnad.
...
- **Välj leverantör utifrån asynkrona arbetsflöden.** OpenAI:s konfigurerbara TTL ger mycket asynkrona arbetsflöden mer kontroll än Anthropics fasta femminutersfönster.
