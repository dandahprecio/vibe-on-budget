...
*(Se [ordlistan](/vibe-on-budget/sv/glossary) för definitioner av outputkomprimering, bakgrundsbatchning, serverless och continuous batching.)*
...
Gå tillbaka till [kontextmodellen](/vibe-on-budget/sv/01-what-happens) och [Vibe coding utan skuld](/vibe-on-budget/sv/06-vibe-coding) för att använda tekniker som kompletterar harnessen. [^m9-1] [^m9-4]
:::
