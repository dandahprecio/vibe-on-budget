...
This project is indexed by GitNexus as **vibe-on-budget** (454 symbols, 451 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
